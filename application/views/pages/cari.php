...
<body>
    ...
    <div class="container py-3">
        <h1 class="text-center p-4"><span class="fs-1">Aneka</span><span class="text-hijau poppins fs-1">Hijau</span></h1>
        <form method='post' action="<?= base_url() ?>Cari/loadRecord" class="row">
            <div class="col"></div>
            <div class="col-8">
                <input type='text' name='search' value='<?= $search ?>' placeholder="Cari Sesuatu ... " class="form-control">
                <small class="text-secondary">*untuk mencari tanaman sesuai kategori cukup ketik hias atau obat.</small>
            </div>
            <div class="col-1">
